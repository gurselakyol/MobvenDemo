...
public class NowPlayingMoviesFragment extends Fragment {
    ...
    public static String REGION = "TR";
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.now_playing_movies_fragment, container, false);

        movieRecycle = view.findViewById(R.id.now_playing_movies_recycler);
